...
const links = [
  {
    label: 'GitHub',
    href: 'https://github.com/s-etai',
    icon: <GitHubIcon />,
    desc: 'See my code',
  },
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/elliott-tai/',
    icon: <LinkedInIcon />,
    desc: 'Connect with me',
  },
  {
    label: 'Email',
    href: 'mailto:elliott.tai@wsu.edu',
    icon: <EmailIcon />,
    desc: 'elliott.tai@wsu.edu',
  },
]
    ...
    <section id="contact">
      <div className="container">
        ...
        <div className={styles.cards}>
          {links.map(({ label, href, icon, desc }) => (
            <a
              key={label}
              href={href}
